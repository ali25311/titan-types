...
// ==========================================================
// Description: This corresponds to test scenario 1, where we create unit tests to see if the functionality is correct with all the given test reults, regarding the Restart button. This is test case 1, it tests to see if the restart button is visible when the application loads.
