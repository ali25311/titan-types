...
all the given test reults, regarding the Restart button. This 
is test case 2, it tests to see if the restart button is reloaded 
to the same values and new quotes appear in the text box.
========================================================== */
